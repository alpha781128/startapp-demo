namespace Startapp.Shared.Authorization
{
    public static class Policies
    {
        ...
        ///<summary>Policy to allow viewing article records.</summary>
        public const string ViewArticlesPolicy = "View Articles";

        ///<summary>Policy to allow adding, removing and updating article records.</summary>
        public const string ManageArticlesPolicy = "Manage Articles";
