...
namespace Startapp.Shared.Core
{
    public static class ApplicationPermissions
    {
        ...
        //public const string ArticlesPermissionGroupName = "Article Permissions";
        //public static ApplicationPermission ViewArticles = new ApplicationPermission("View Articles", "articles.view", ArticlesPermissionGroupName, "Permission to view other articles");
        //public static ApplicationPermission ManageArticles = new ApplicationPermission("Manage Articles", "articles.manage", ArticlesPermissionGroupName, "Permission to create, delete and modify other articles");
